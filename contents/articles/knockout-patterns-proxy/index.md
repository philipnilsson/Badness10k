...
<div id="ex" style="overflow: hidden; padding: 0.5em 0 1em 0">
 <div style="width: 39%; float: left; border: 1px solid lightgray; padding: 2%; font-size: 65%;">
 ...
 <div id="ex_log" style="width: 51%; height: 100%; float: right; border: 1px solid lightgray; padding: 2%; font-size: 65%;">
